...
function parseTimestampToDate( userObject ) {

    console.log("utils -> Input : " + userObject.last_online_date);
    

    let parsedDatabaseTimestamp = userObject.last_online_date.substr(0, 4)
    + "-" + userObject.last_online_date.substr(5, 2)
    + "-" + userObject.last_online_date.substr(8, 2)
    + " " + userObject.last_online_date.substr(11, 2)
    + ":" + userObject.last_online_date.substr(14, 2)
    + ":" + userObject.last_online_date.substr(17, 2)

    console.log("utils -> Output : " + parsedDatabaseTimestamp );


    return new Date(parsedDatabaseTimestamp);
}
